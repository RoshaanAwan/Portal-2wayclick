...
import { FILE_TYPE_META, type FileTypeKey } from "./fileTypes";

// Details returned by /api/documents/upload once a real file is stored.
interface Uploaded {
  url: string;
...
export function AddDocumentButton({
  ...
  async function handleFile(file: File) {
    ...
    try {
      ...
      // Seed the title from the filename if the user hasn't typed one.
